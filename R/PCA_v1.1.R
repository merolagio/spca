...
pca = function(S, nd, only.values = FALSE, screeplot= FALSE, kaiser.print = FALSE){
  ...
  ## nd iinteger numberof dimensions to compute
  ## screeplot = TRUE plots the eigenvalues
  ## kaiser.print = TRUE gives the number of eigenvalues > 1 (warning if S not correlation)
  #######=============================================================  
