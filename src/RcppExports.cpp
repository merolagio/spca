...
// vifXC
Eigen::VectorXd vifXC(Eigen::Map<Eigen::MatrixXd> X, Eigen::VectorXi ind, bool intercept);
static SEXP _spca_vifXC_try(SEXP XSEXP, SEXP indSEXP, SEXP interceptSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Eigen::Map<Eigen::MatrixXd> >::type X(XSEXP);
    Rcpp::traits::input_parameter< Eigen::VectorXi >::type ind(indSEXP);
    Rcpp::traits::input_parameter< bool >::type intercept(interceptSEXP);
    rcpp_result_gen = Rcpp::wrap(vifXC(X, ind, intercept));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _spca_vifXC(SEXP XSEXP, SEXP indSEXP, SEXP interceptSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_spca_vifXC_try(XSEXP, indSEXP, interceptSEXP));
    }
...
static SEXP _spca_vifSC_try(SEXP SSEXP, SEXP indSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
...
RcppExport SEXP _spca_vifSC(SEXP SSEXP, SEXP indSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_spca_vifSC_try(SSEXP, indSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static SEXP _spca_vifSPseudoC_try(SEXP SSEXP, SEXP indSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Eigen::Map<Eigen::MatrixXd> >::type S(SSEXP);
    Rcpp::traits::input_parameter< Eigen::VectorXi >::type ind(indSEXP);
...
RcppExport SEXP _spca_vifSPseudoC(SEXP SSEXP, SEXP indSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_spca_vifSPseudoC_try(SSEXP, indSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _spca_RcppExport_validate(const char* sig) { 
    static std::set<std::string> signatures;
    if (signatures.empty()) {
        signatures.insert("Eigen::VectorXd(*vifXC)(Eigen::Map<Eigen::MatrixXd>,Eigen::VectorXi,bool)");
        signatures.insert("Eigen::VectorXd(*vifSC)(Eigen::Map<Eigen::MatrixXd>,Eigen::VectorXi)");
        signatures.insert("Eigen::VectorXd(*vifSPseudoC)(Eigen::Map<Eigen::MatrixXd>,Eigen::VectorXi)");
    }
    return signatures.find(sig) != signatures.end();
}

// registerCCallable (register entry points for exported C++ functions)
RcppExport SEXP _spca_RcppExport_registerCCallable() { 
    R_RegisterCCallable("spca", "_spca_vifXC", (DL_FUNC)_spca_vifXC_try);
    R_RegisterCCallable("spca", "_spca_vifSC", (DL_FUNC)_spca_vifSC_try);
    R_RegisterCCallable("spca", "_spca_vifSPseudoC", (DL_FUNC)_spca_vifSPseudoC_try);
    R_RegisterCCallable("spca", "_spca_RcppExport_validate", (DL_FUNC)_spca_RcppExport_validate);
    return R_NilValue;
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_spca_vifXC", (DL_FUNC) &_spca_vifXC, 3},
    {"_spca_vifSC", (DL_FUNC) &_spca_vifSC, 2},
    {"_spca_vifSPseudoC", (DL_FUNC) &_spca_vifSPseudoC, 2},
    {"_spca_RcppExport_registerCCallable", (DL_FUNC) &_spca_RcppExport_registerCCallable, 0},
    {NULL, NULL, 0}
};
