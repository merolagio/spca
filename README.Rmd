...
```
<img src="man/figures/spca_Logo.png" align="right" height="139" alt="spca logo" />
...
The  main function is *spca()*. Methods are print, summery and plot. Functions are new.spca (to create an `spca' object from a set of loadings and aggregate_by_scale to visualize the contribution by scale.
