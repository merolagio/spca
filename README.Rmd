...
This package contains functions to compute, visualize and compare Least Squares Sparse Principal Components Analysis (LS-SPCA). An efficient `C++` backend makes the fitting functions fast and memory efficient. Methodological details, references and full presentation can be found in the *spca_extended* vignette.
